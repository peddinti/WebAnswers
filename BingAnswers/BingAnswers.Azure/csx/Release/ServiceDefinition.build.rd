...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="BingAnswers.Azure" generation="1" functional="0" release="0" Id="58683610-6a29-485a-8fc1-5326b587db8e" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="BingAnswers.AzureGroup" generation="1" functional="0" release="0">
      <componentports>
        ...
        <inPort name="BingAnswers:Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint" protocol="tcp">
          <inToChannel>
            <lBChannelMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/LB:BingAnswers:Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint" />
          </inToChannel>
        </inPort>
      </componentports>
      <settings>
        <aCS name="BingAnswers:CloudToolsDiagnosticAgentVersion" defaultValue="">
          <maps>
            <mapMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/MapBingAnswers:CloudToolsDiagnosticAgentVersion" />
          </maps>
        </aCS>
        <aCS name="BingAnswers:IntelliTrace.IntelliTraceConnectionString" defaultValue="">
          <maps>
            <mapMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/MapBingAnswers:IntelliTrace.IntelliTraceConnectionString" />
          </maps>
        </aCS>
      ...
      <channels>
        ...
        <lBChannel name="LB:BingAnswers:Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint">
          <toPorts>
            <inPortMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/BingAnswers/Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint" />
          </toPorts>
        </lBChannel>
      ...
      <maps>
        <map name="MapBingAnswers:CloudToolsDiagnosticAgentVersion" kind="Identity">
          <setting>
            <aCSMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/BingAnswers/CloudToolsDiagnosticAgentVersion" />
          </setting>
        </map>
        <map name="MapBingAnswers:IntelliTrace.IntelliTraceConnectionString" kind="Identity">
          <setting>
            <aCSMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/BingAnswers/IntelliTrace.IntelliTraceConnectionString" />
          </setting>
        </map>
      ...
      <components>
        <groupHascomponents>
          <role name="BingAnswers" generation="1" functional="0" release="0" software="D:\personal\Bing Web Answers\BingAnswers\BingAnswers.Azure\csx\Release\roles\BingAnswers" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
            ...
            <settings>
              ...
              <aCS name="__ModelData" defaultValue="&lt;m role=&quot;BingAnswers&quot; xmlns=&quot;urn:azure:m:v1&quot;&gt;&lt;r name=&quot;BingAnswers&quot;&gt;&lt;e name=&quot;Endpoint1&quot; /&gt;&lt;e name=&quot;Microsoft.WindowsAzure.Plugins.RemoteAccess.Rdp&quot; /&gt;&lt;e name=&quot;Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput&quot; /&gt;&lt;e name=&quot;Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint&quot; /&gt;&lt;/r&gt;&lt;/m&gt;" />
            </settings>
            <resourcereferences>
  ...
  <implements>
    <implementation Id="74751baf-f288-47a9-8415-23ba67d64e63" ref="Microsoft.RedDog.Contract\ServiceContract\BingAnswers.AzureContract@ServiceDefinition.build">
      <interfacereferences>
        <interfaceReference Id="24b33747-d7d5-467f-bfbb-bd6415972eb2" ref="Microsoft.RedDog.Contract\Interface\BingAnswers:Endpoint1@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/BingAnswers:Endpoint1" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="a31fde23-210c-4920-921e-b9cbd4697425" ref="Microsoft.RedDog.Contract\Interface\BingAnswers:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/BingAnswers:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="911344c0-3af2-40d2-a82e-e112c4bb42f4" ref="Microsoft.RedDog.Contract\Interface\BingAnswers:Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/BingAnswers.Azure/BingAnswers.AzureGroup/BingAnswers:Microsoft.WindowsAzure.Plugins.WebDeploy.InputEndpoint" />
          </inPort>
        </interfaceReference>
